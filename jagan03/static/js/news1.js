...
jssor_slider16_starter = function (containerId) {
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                var parentElement = jssor_slider16.$Elmt.parentNode;
                ...
                if (parentWidth) {
                    ...
                    var sliderWidth = availableWidth * 0.665;

                    //slider width is maximum 600
                    sliderWidth = Math.min(sliderWidth, 1600);

                    //slider width is minimum 200
                    sliderWidth = Math.max(sliderWidth, 600);
                    var clearFix = "none";
                    ...
                    jssor_slider16.$ScaleWidth(sliderWidth);
                }
                else
